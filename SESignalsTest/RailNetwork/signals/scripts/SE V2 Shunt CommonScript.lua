...
--------------------------------------------------------------------------------------
--include=SE DwarfScript.lua



-- Everything else is in the SE DwarfScript
-------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------
-- Swedish dwarf signals SetSwitchLights
-- Switch the appropriate lights on and off based on our new state
function SetSwitchLights()
	DebugPrint("SetSwitchLights()")
...
function OnSignalMessage( message, parameter, direction, linkIndex )
	...
	if not gDwarfInitialised then
		gDwarfInitialised = true
		if gHomeSignal then
			Call("BeginUpdate")
		end
	end
...
function BaseOnSignalMessage( message, parameter, direction, linkIndex )
	...
	if (message >= CROSSING_GO and message < PASS_OFFSET or
		 message >= CROSSING_GO + PASS_OFFSET)  then
		-- don't interfere with other types of signals (crossings)
