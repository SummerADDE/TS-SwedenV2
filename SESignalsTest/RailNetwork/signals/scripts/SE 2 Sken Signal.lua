...
-- 200420 Tvåskenssignalering
-- 200428 Tvåskenssignalering korrigerad
...
function DefaultAnimate()
	if gHomeSignal and (gSignalState ~= STATE_SLOW) then
		return
	end
	...
	elseif (gExpectState == STATE_SLOW) then
		...
		SwitchLight( LIGHT_NODE_GREEN, gLightFlashOn )
	end
end
